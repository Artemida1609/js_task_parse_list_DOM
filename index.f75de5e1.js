...
function getEmployees(employeesList) {
    ...
    for(let i = 0; i < employeesList.length; i++){
        ...
        const salary = parseInt(employeesList[i].getAttribute("data-salary").replace(/[$,]/g, ""));
...
for(let i = 0; i < sortedEmployees.length; i++)list[i].innerHTML = sortedEmployees[i].employeeName;
